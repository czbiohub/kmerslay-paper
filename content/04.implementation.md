...
$$\mathrm{Pr}(\mathrm{random } k-\mathrm{-mer in protein translation}) &= \frac{1}{\left| \Sigma \right|^k * \left( \frac{1}{\left| \Sigma \right| \right)^{L_{\mathrm{translated}} - k + 1}\\ &= \frac{1}{\left| \Sigma \right|^k  * \left| \Sigma \right| \right)^{L_{\mathrm{translated}} - k + 1}} \\&= \frac{1}{\left| \Sigma \right|^L_{\mathrm{translated}}}$$ {#eq:prob_kmers_in_read}
